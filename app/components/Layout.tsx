...
function MobileHeader({
  ...
  return (
    <header
      role="banner"
      className={
        'bg-white flex lg:hidden items-center h-nav sticky z-40 top-0 justify-between w-full leading-none gap-4 px-4 md:px-8'
      }
    >
    ...
    >
      ...
      <div className="flex items-center gap-1">
        ...
        >
          ...
          <button
            type="submit"
            className="relative flex items-center justify-center w-8 h-8 focus:ring-primary/5 text-black"
          >
            <IconSearch />
          </button>
        </Form>
  ...
  const BadgeCounter = useMemo(
    () => (
      <>
        <IconBag />
        <div
          className={`bg-black absolute bottom-1 right-1 text-[0.625rem] font-medium subpixel-antialiased h-3 min-w-[0.75rem] flex items-center justify-center leading-none text-center rounded-full w-auto px-[0.125rem] pb-px`}
        >
          <span>{count || 0}</span>
        </div>
      </>
